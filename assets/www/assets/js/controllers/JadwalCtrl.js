app.controller('JadwalCtrl', function (_Sweet, $scope, $ionicSideMenuDelegate, $state, _booking, _store, $rootScope) {
  ...
  $scope.$on("$ionicView.beforeEnter", function () {
    ...
    _booking.getQueueUpdate().then(function (success) {
      console.warn(success.data.QUEUE_UPDATE || [])
