...
(function(angular) {
  ...
  angular.module('esri.core').factory('esriLoader', ['$q', function ($q) {
       ...
       *  Defaults to `{url: 'https://js.arcgis.com/3.21compact'}`
       *
      ...
      function bootstrap(options) {
          ...
          script.src    = opts.url || window.location.protocol + '//js.arcgis.com/3.21compact';
...
(function(angular) {
   ...
   */
  angular.module('esri.map').controller('EsriMapController', ['$attrs', '$timeout', 'esriMapUtils', 'esriRegistry', function EsriMapController($attrs, $timeout, esriMapUtils, esriRegistry) {
...
(function(angular) {
  ...
  angular.module('esri.map')
      .directive('esriLegend', ['$q', 'esriLoader', function($q, esriLoader) {
          return {
              //run last
              priority: -10,
              restrict: 'EA',
...
(function(angular) {
   ...
   */
  angular.module('esri.map').controller('EsriFeatureLayerController', ['$controller', 'esriLayerUtils', function EsriFeatureLayerController($controller, esriLayerUtils) {
...
(function(angular) {
   ...
   * and help bind layer events and other properties such as layer visibility.
   */
  angular.module('esri.map').controller('EsriDynamicMapServiceLayerController', ['$controller', 'esriLayerUtils', function EsriDynamicMapServiceLayerController($controller, esriLayerUtils) {
...
(function(angular) {
   ...
   * and help bind layer events and other properties such as layer visibility.
   */
  angular.module('esri.map').controller('EsriVectorTileLayerController', ['$controller', 'esriLayerUtils', function EsriVectorTileLayerController($controller, esriLayerUtils) {
